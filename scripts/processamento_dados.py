...
class Dados:
    ...
    # Função que le os dois tipos de arquivos tendo o caminho e o tipo do arquivo como parametro de entrada
    ...
    def salvando_dados(self, path):
        dados_combionados_tabela = self.__transformando_dados_tabela()

        with open(path, 'w') as file:
            writer = csv.writer(file)
            writer.writerows(dados_combionados_tabela)